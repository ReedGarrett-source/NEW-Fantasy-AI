...
function calculateHittingTotals(
  games
) {
  const totals = {
    G: 0,
  ...
  /*
    We cannot simply add OBP/SLG/OPS.
    Calculate the rate stats from
...
function calculatePitchingTotals(
  games
) {
  let innings =
    0;
    ...
    try {
      ...
      */
      ...
      if (
        ...
        /*
          Remove common baseball words
          before sending the search query.
        */
